...
const Projects: FC<SideMenuProps>  = (props): JSX.Element =>{
    ...
    //HOVER
    const handleMouseEnter = (e:React.MouseEvent<HTMLDivElement, MouseEvent>| React.TouchEvent) => {
        if(e.currentTarget.id == 'd2'){
            setFrontBox({...frontBox, transition: '0.3s', marginBottom: '5%'})
        }
        if(e.currentTarget.id == 'd3'){
            setFirstToLeft({...firstToLeft, transition: '0.3s', marginBottom: '5%'})
        }
        if(e.currentTarget.id == 'd4'){
            setSecondToLeft({...secondToLeft, transition: '0.3s', marginBottom: '5%'})
        }
        if(e.currentTarget.id == 'd5'){
            setFirstToRight({...firstToRight, transition: '0.3s', marginBottom: '5%'})
        }
        if(e.currentTarget.id == 'd6'){
            setSecondToRight({...secondToRight, transition: '0.3s', marginBottom: '5%'})
        }
        
    }
    const handleMouseLeave = (e:React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        if(e.currentTarget.id == 'd2'){
            setFrontBox({...frontBox, transition: '0.3s', marginBottom: '3%'})
        }
        if(e.currentTarget.id == 'd3'){
            setFirstToLeft({...firstToLeft, transition: '0.3s', marginBottom: '3%'})
        }
        if(e.currentTarget.id == 'd4'){
            setSecondToLeft({...secondToLeft, transition: '0.3s', marginBottom: '3%'})
        }
        if(e.currentTarget.id == 'd5'){
            setFirstToRight({...firstToRight, transition: '0.3s', marginBottom: '3%'})
        }
        if(e.currentTarget.id == 'd6'){
            setSecondToRight({...secondToRight, transition: '0.3s', marginBottom: '3%'})
        }
        
    }

    const handleSmallBoxHover = (e:React.MouseEvent<HTMLDivElement, MouseEvent>| React.TouchEvent) =>{
        if(e.currentTarget.id == 'd2'){
            setFrontBox({...frontBox, transition: '0.3s', marginBottom: '3%'})
        }
        if(e.currentTarget.id == 'd3'){
    ...
    const handleSmallBoxLeave = (e:React.MouseEvent<HTMLDivElement, MouseEvent>) =>{
        if(e.currentTarget.id == 'd2'){
            setFrontBox({...frontBox, transition: '0.3s', marginBottom: '0%'})
        }
        if(e.currentTarget.id == 'd3'){
            setFirstToLeft({...firstToLeft, transition: '0.3s', marginBottom: '0%'})
        }
        if(e.currentTarget.id == 'd4'){
            setSecondToLeft({...secondToLeft, transition: '0.3s', marginBottom: '0%'})
        }
        if(e.currentTarget.id == 'd5'){
            setFirstToRight({...firstToRight, transition: '0.3s', marginBottom: '0%'})
        }
        if(e.currentTarget.id == 'd6'){
            setSecondToRight({...secondToRight, transition: '0.3s', marginBottom: '0%'})
        }
    }
...
const handleDragEvent = (e: DraggableEvent, y: DraggableData) =>{
    ...
    //right
    if(direction.start > y.x +100){
        setDirection({...direction,right:true , start: 0})
        handleClickLeftChange
    }
    //left
    if(direction.start < y.x-100){
...
// BOTH CLICKS 
const handleClickLeftChange = (e: React.MouseEvent<HTMLDivElement> | React.TouchEvent) =>{
    if(e.currentTarget.id == trackPosition.leftClick || direction.left){
    ...
    if(e.currentTarget.id == trackPosition.rightClick || direction.right){
        let x:number = dragLeft
        setSmallBox({...smallBox, transform: 'scale(0)', transition: '0' })
        setNextPosition(nextPosition+1)
        setRightClick(rightClick+1)
    ...
    return(
        <div  style={{...AppStyles,...props.tempStyle}} >
            ...
            <div id="controls" className='projectsContainer' >
                <Draggable nodeRef={nodeRef} position={{x: dragLeft, y: 0}} axis="x" onStop={handleDragEvent} onStart={handleDragStart}>
                    <div id='d1' ref={nodeRef}  style={rowContainer}  >
                        ...
                        <div id='d2' style={frontBox}  onClick={handleClickLeftChange} onMouseEnter={trackPosition.one ? handleMouseEnter : handleSmallBoxHover} onMouseLeave={trackPosition.one ? handleMouseLeave : handleSmallBoxLeave}>
                        
                        <img src={projectsItems[currentPosition.front].image} className='containerImage' />
                                ...
                                <p style={textIn}>{projectsItems[currentPosition.front].intro}</p>
                                    <div className='buttonRowInBox'>
                                        ...
                                        <a style={buttonIn} href={projectsItems[currentPosition.front].link ? projectsItems[currentPosition.front].link : undefined}>
                                            <div>
                                                <p className='textInBox'>{projectsItems[currentPosition.front].button1}</p>
                                        ...
                                        {projectsItems[currentPosition.front].button2 ? (<div style={buttonIn} >
                                            ...
                                            <p className='textInBox'>{projectsItems[currentPosition.front].button2}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.front].button3 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.front].button3}</p>
                                        </div>) : (<></>)}

                                       {projectsItems[currentPosition.front].button4 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.front].button4}</p>
                                        </div>) : (<></>)}
                                    </div>
                        </div>) : (<></>)}
                        </div>
                        ...
                        <div  id='d3' style={firstToLeft} onClick={handleClickLeftChange} onMouseEnter={trackPosition.two ? handleMouseEnter : handleSmallBoxHover} onMouseLeave={trackPosition.two ? handleMouseLeave : handleSmallBoxLeave}>
                        <img src={projectsItems[currentPosition.left1].image} className='containerImage' />
                            {trackPosition.two ? (<div style={smallBox}>
                                ...
                                <div className='buttonRowInBox'>
                                        ...
                                        <a style={buttonIn} href={projectsItems[currentPosition.left1].link ? projectsItems[currentPosition.left1].link : undefined}>
                                            <div>
                                                <p className='textInBox'>{projectsItems[currentPosition.left1].button1}</p>
                                            
                                            </div>
                                        </a>) : (<></>)}

                                        {projectsItems[currentPosition.left1].button2 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left1].button2}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.left1].button3 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left1].button3}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.left1].button4 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left1].button4}</p>
                                        </div>) : (<></>)}
                                    </div>   
                        </div>) : (<></>)}
                        </div>
                        ...
                        <div id='d4' style={secondToLeft} onClick={handleClickLeftChange} onMouseEnter={trackPosition.three ? handleMouseEnter : handleSmallBoxHover} onMouseLeave={trackPosition.three ? handleMouseLeave : handleSmallBoxLeave} >
                        <img src={projectsItems[currentPosition.left2].image} className='containerImage' />
                            {trackPosition.three  ? (<div style={smallBox}>
                                ...
                                <div className='buttonRowInBox'>
                                        ...
                                        <a style={buttonIn} href={projectsItems[currentPosition.left2].link ? projectsItems[currentPosition.left2].link : undefined}>
                                            <div>
                                                <p className='textInBox'>{projectsItems[currentPosition.left2].button1}</p>
                                            
                                            </div>
                                        </a>) : (<></>)}

                                        {projectsItems[currentPosition.left2].button2 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left2].button2}</p>
                                        </div>) : (<></>)}

                                       {projectsItems[currentPosition.left2].button3 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left2].button3}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.left2].button4 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.left2].button4}</p>
                                        </div>) : (<></>)}
                                    </div>   
                        </div>) : (<></>)}
                        </div>
                        ...
                        <div id='d5' style={firstToRight}  onClick={handleClickLeftChange} onMouseEnter={trackPosition.five ? handleMouseEnter : handleSmallBoxHover} onMouseLeave={trackPosition.five ? handleMouseLeave : handleSmallBoxLeave}>
                        <img src={projectsItems[currentPosition.right1].image} className='containerImage' />
                        {trackPosition.five ? (<div style={smallBox}>
                            ...
                            <div className='buttonRowInBox'>
                                ...
                                <a style={buttonIn} href={projectsItems[currentPosition.right1].link ? projectsItems[currentPosition.right1].link : undefined}>
                                            <div>
                                                <p className='textInBox'>{projectsItems[currentPosition.right1].button1}</p>
                                            
                                            </div>
                                        </a>) : (<></>)}
                                        
                                        {projectsItems[currentPosition.right1].button2 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right1].button2}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.right1].button3 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right1].button3}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.right1].button4 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right1].button4}</p>
                                        </div>) : (<></>)}
                                    </div>   
                        </div>) : (<></>)}
                        </div>
                        ...
                        <div id='d6' style={secondToRight} onClick={handleClickLeftChange} onMouseEnter={trackPosition.four ? handleMouseEnter : handleSmallBoxHover} onMouseLeave={trackPosition.four ? handleMouseLeave : handleSmallBoxLeave}>
                        <img src={projectsItems[currentPosition.right2].image} className='containerImage' />
                        {trackPosition.four ? (<div style={smallBox}> 
                            ...
                            <div className='buttonRowInBox'>
                                ...
                                <a style={buttonIn} href={projectsItems[currentPosition.right2].link ? projectsItems[currentPosition.right2].link : undefined}>
                                            <div>
                                                <p className='textInBox'>{projectsItems[currentPosition.right2].button1}</p>
                                            
                                            </div>
                                        </a>) : (<></>)}

                                        {projectsItems[currentPosition.right2].button2 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right2].button2}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.right2].button3 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right2].button3}</p>
                                        </div>) : (<></>)}

                                        {projectsItems[currentPosition.right2].button4 ? (<div style={buttonIn}>
                                            <p className='textInBox'>{projectsItems[currentPosition.right2].button4}</p>
                                        </div>) : (<></>)}
                                    </div>  
                        </div>) : (<></>)}
                        </div>
